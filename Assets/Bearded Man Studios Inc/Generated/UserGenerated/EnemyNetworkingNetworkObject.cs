...
{
	[GeneratedInterpol("{\"inter\":[0.1,0.1,0,0]")]
	public partial class EnemyNetworkingNetworkObject : NetworkObject
	{
		...
		public EnemyNetworkingNetworkObject() : base() { Initialize(); }
		public EnemyNetworkingNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public EnemyNetworkingNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
